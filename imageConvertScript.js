...
function convertMarkdownImagesToHtml(content) {
    ...
    return content.replace(markdownImageRegex, (match, altText, imageSrc) => {
        ...
        return `<img src="https://raw.githubusercontent.com/vvduth/quicksight-01/refs/heads/main/markdown/dockerized-laravel-project/${imageSrc}" alt="${alt}" style="${IMAGE_STYLE}" />`;
    });
}
